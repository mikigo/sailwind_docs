...
2. 在[查看网络对话框](/layout/guide/Dialogs/55_zh.md#23)中，在网络列表选择 **+5V** 
...
5. 点击**确定**应用可见性设置并关闭[查看网络对话框](/layout/guide/Dialogs/55_zh.md#23)
...
1. **设计工具栏**按钮
2. **移动**按钮
3. [输入无模命令](/layout/guide/2_zh.md#11)**ssu1**并按**Enter**搜索选择 U1。U1 附着到鼠标且 U1 连接的所有网络出现
4. 将 U1 放置在 X**1400**,Y**800**并点击放置
5. [输入无模命令](/layout/guide/2_zh.md#11)**ssu2**并按**Enter**搜索选择 U2
6. U2 附着到鼠标后，从左到右水平移动 U2 并观察网络如何重新连接。这称为*动态重连*，在放置组件时很有用
7. [输入无模命令](/layout/guide/2_zh.md#11)**s1400 1450**将 U2 定位在 X**1400**,Y**1450**并按**空格键**放置
...
1. [输入无模命令](/layout/guide/2_zh.md#11)**ssc1**并按**Enter**搜索选择 C1。
    
    > [!NOTE]
    >
    > C1 附着到鼠标，但其网络不可见因为+5V 和 GND 网络已隐藏
...
1. [输入无模命令](/layout/guide/2_zh.md#11)**drp**并按**Enter**启用在线 DRC
2. 移动激活时，[输入无模命令](/layout/guide/2_zh.md#11)**ssy1**并按**Enter**搜索选择 Y1。Y1 附着到鼠标
...
6. [输入无模命令](/layout/guide/2_zh.md#11)**dro**并按**Enter**禁用在线 DRC
7. 点击**确定**确认操作
...
1. **编辑**菜单 > **查找**
2. 在[查找对话框](/layout/guide/Dialogs/49_zh.md#15)的查找依据列表选择**参考标识符**
3. 在参考标识前缀列表选择**J**，在参考标识列表选择**J1**
4. 点击**应用**。
    
    > [!NOTE]
    >
    > J1 附着到鼠标。此时不要关闭[查找对话框](/layout/guide/Dialogs/49_zh.md#15)
5. 在设计区域，右键点击选择**翻转面**
6. 在**X1650**,**Y400**点击放置 J1

**放置电容 C7**

1. 在[查找对话框](/layout/guide/Dialogs/49_zh.md#15)，从参考标识前缀列表选择**C**，从参考标识列表选择**C7**
2. 点击**应用**
...
您可以选择多个组件并自动依次移动每个元件。您将使用此方法放置电阻 R1、R2 和 R5。

1. 设计工具栏 > **选择**按钮

2. 在[查找对话框](/layout/guide/Dialogs/49_zh.md#15)的操作列表选择**顺序移动**
...
6. 对提示消息点击**全部是**。
   ...
   > [!NOTE]
   >
   > 组中第一个组件附着到鼠标。第一个组件放置后，组中下一个组件自动附着到鼠标
...
8. 关闭[查找对话框](/layout/guide/Dialogs/49_zh.md#15)

## 使用属性对话框放置组件 \{#5}

您可以使用组件属性对话框放置元件。使用此方法放置 LED 及其电阻。这些元件放置在板右侧的圆弧周围。

1. **视图**菜单 > **范围**
2. [输入无模命令](/layout/guide/2_zh.md#11)**ssd1**并按**Enter**
3. 右键点击选择**属性**
