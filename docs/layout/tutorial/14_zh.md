...
1. **[`ECO` 工具栏](/layout/guide/36_zh.md#2)**按钮。
    > [!TIP]
 如果 [`ECO` 选项对话框](/layout/guide/Dialogs/49_zh.md#1)未出现，点击 [`ECO` 工具栏](/layout/guide/36_zh.md#2)>选项按钮
2. 在 [`ECO` 选项对话框](/layout/guide/Dialogs/49_zh.md#1)中，勾选**写入 `ECO` 文件**复选框并取消勾选**追加到文件**复选框。保留文件名 previewassy.eco
3. 勾选**关闭 [`ECO` 工具栏](/layout/guide/36_zh.md#2)后写入 `ECO` 文件**复选框
4. 点击**确定**
...
6. 点击**确定**开始自动重编号
7. 在标准工具栏上，点击**[`ECO` 工具栏](/layout/guide/36_zh.md#2)**按钮关闭 [`ECO` 工具栏](/layout/guide/36_zh.md#2)并将更改写入 `ECO` 文件
