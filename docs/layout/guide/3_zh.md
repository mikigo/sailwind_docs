...
| 名称                        | 命令 | 描述                                                                                                                                                                                                                                                                                                                                                                        |
|-----------------------------|------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 减小显示宽度                | R `<n>`   | 将常规选项中的"最小显示宽度"设置为`<n>`，例如 R 50。任何小于此值的线宽将绘制为单像素中心线。由于当今显卡的强大功能，此功能不再需要用于加快刷新时间，但仍用于帮助选择非常小的线段。                                                                                                                         |
...
| 名称                                   | 命令      | 描述                                                                                             |
|----------------------------------------|-----------|-------------------------------------------------------------------------------------------------|
| 绝对搜索                              | S `<x>` `<y>` | 绝对搜索。将鼠标移动到指定的 X 和 Y 坐标，例如 S 1000 1000。                                         |
| 搜索参考标志符/管脚                   | S `<s>`     | 搜索参考标志符/管脚`<s>`，例如 S U1.1 或 S U1。                                                      |
| 相对搜索                              | SR `<x>` `<y>` | 相对搜索。按指定的 X 和 Y 偏移移动鼠标，例如 SR -100 -50。                                           |
| 相对 X 搜索                                           | SRX `<x>` | 在当前 Y 位置进行相对 X 搜索。按指定的 X 偏移移动鼠标，例如 SRX 300。                                                                                                                                                                                                                             |
| 相对 Y 搜索                                           | SRY `<y>` | 在当前 X 位置进行相对 Y 搜索。按指定的 Y 偏移移动鼠标，例如 SRY 400。                                                                                                                                                                                                                             |
...
| 绝对移动到`<n>`，当前 Y                               | SX `<x>`  | 在当前 Y 坐标处进行绝对 X 移动。将鼠标移动到指定的 X 坐标和当前 Y 坐标，例如 SX 300。                                                                                                                                                                                                               |
| 绝对移动到`<n>`，当前 X                               | SY `<y>`  | 在当前 X 坐标处进行绝对 Y 移动。将鼠标移动到指定的 Y 坐标和当前 X 坐标，例如 SY 400。                                                                                                                                                                                                               |
...
| 名称               | 命令 | 描述                                                                                                                                                                                                      |
|--------------------|------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 对象捕捉模式       | OS   | 在对象捕捉选项切换捕捉到对象模式开/关。                                                                                                                                                           |
| 对象捕捉半径       | OSR `<n>` | 在对象捕捉选项将捕捉半径设置为指定值(以当前设计单位)。如果未给出值，OSR 在状态栏中显示当前捕捉半径值。                                                                                              |
| 对象捕捉类型       | OS `<n>`  | 在对象捕捉选项设置捕捉到对象类型并清除未选中的类型。您可以使用以下一个或多个值：                                                                                                                   |
|                    |      | • C — 圆或圆弧的中心。                                                                                                                                                                                   |
|                    |      | • E — 绘图形状或线端的角。                                                                                                                                                                               |
|                    |      | • I — 交点；两条线或圆弧的交叉点。                                                                                                                                                                       |
|                    |      | • M — 线或圆弧的中点。                                                                                                                                                                                   |
...
| 管脚编号显示开/关 | PN   | 切换管脚编号的显示。此命令还会切换[显示颜色设置对话框](/layout/guide/Dialogs/48_zh.md#31)中的管脚编号列复选框。大小由显示选项中的设置控制。 |
| 透明模式开/关     | T    | 切换对象显示为透明或不透明。另请参阅："[透明视图模式](/layout/guide/2_zh.md#20)"。   |
| 文本边框开/关     | X    | 切换文本边框的显示。                                         |
...
| 名称                                                 | 命令 | 描述                                                                                                                                                                                                                                              |
|------------------------------------------------------|------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 逐个高亮网络                                         | N `<s>`   | 逐个高亮网络。要将高亮网络`<s>`置于堆栈顶部，重复该命令，例如 N GND。提示高亮网络采用显示颜色对话框中指定的高亮颜色。                                                                                                                 |
...
|  |  | 此命令切换[显示颜色设置对话框](/layout/guide/Dialogs/48_zh.md#31)中的网络名称复选框(对象类型-列)。 |
|  |  | 当网络名列复选框启用时，网络名称可见性仍受每层颜色块和显示走线、过孔、管脚上的网络名称复选框的限制。<br/>另请参阅 NNP、NNT 和 NNV 无模命令。 |
|  |  | 网络名称放置的大小和频率由显示选项中的设置控制。 |
| 切换管脚上网络名称显示                   | NNP  | 切换管脚上网络名称的显示。                                                                                                                                                                                                                                                                                                                                                                                                             |
|                                          |      | 此命令切换[显示颜色设置对话框](/layout/guide/Dialogs/48_zh.md#31)中的显示管脚上网络名称复选框。大小由显示选项中的设置控制。                                                                                                                                                                                                                                                                                                                                         |
|                                          |      | 网络名称的显示还取决于网络名称复选框和[显示颜色设置对话框](/layout/guide/Dialogs/48_zh.md#31)中该层上非背景颜色块的存在。                                                                                                                                                                                                                                                                                                                                                   |
| 切换走线上网络名称显示                   | NNT  | 切换走线上网络名称的显示。此命令切换[显示颜色设置对话框](/layout/guide/Dialogs/48_zh.md#31)中的走线上网络名称复选框。放置的大小和频率由显示选项中的设置控制。网络名称的显示还取决于网络名称复选框和[显示颜色设置对话框](/layout/guide/Dialogs/48_zh.md#31)中该层上非背景颜色块的存在。                                                                                                                                                                                                                 |
| 切换过孔上网络名称显示                   | NNV  | 切换过孔上网络名称的显示。此命令切换[显示颜色设置对话框](/layout/guide/Dialogs/48_zh.md#31)中的过孔上网络名称复选框。大小由显示选项中的设置控制。                                                                                                                                                                                                                                                                                                                    |
|                                          |      | 网络名称的显示还取决于网络名称复选框和[显示颜色设置对话框](/layout/guide/Dialogs/48_zh.md#31)中该层上非背景颜色块的存在。                                                                                                                                                                                                                                                                                                                                                   |
...
| 名称                    | 命令   | 描述                                                                                                 |
|-------------------------|--------|-----------------------------------------------------------------------------------------------------|
| 切换[结束过孔模式](/layout/guide/32_zh.md#9-3)        | E      | 循环切换[结束过孔模式](/layout/guide/32_zh.md#9-3)：                                                                              |
|                         |        | • 结束无过孔(走线在空间中结束)                                                                      |
|                         |        | • 结束过孔(走线以过孔结束)                                                                          |
|                         |        | • 结束测试点(走线以测试点过孔结束)                                                                  |
|                         |        | 提示查看状态栏了解您切换到的模式。                                                              |
| 打开[过孔对话框](/layout/guide/Dialogs/55_zh.md#21)          | V      | 打开[过孔对话框](/layout/guide/Dialogs/55_zh.md#21)。                                                                                    |
| 自动过孔选择            | VA     | 在[过孔对话框](/layout/guide/Dialogs/55_zh.md#21)中将过孔模式设置为自动。详见对话框主题获取更多信息。                                    |
| 使用部分过孔            | VP     | 在[过孔对话框](/layout/guide/Dialogs/55_zh.md#21)中将过孔模式设置为部分。详见对话框主题获取更多信息。                                    |
| 使用通孔过孔            | VT `<name>` | 在[过孔对话框](/layout/guide/Dialogs/55_zh.md#21)中将过孔模式设置为通孔。如果存在多个过孔，您还可以键入要使用的过孔名称。详见对话框主题获取更多信息。 |
...
| 名称                | 命令 | 描述                                                                                                                                                                                    |
|---------------------|------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 灌铜边框开/关       | PO   | 切换灌铜边框开/关，并在"覆铜平面/填充和灌铜"选项中切换覆铜平面的显示模式为灌铜边框或填充边框。                                                                                     |

**表 26. 边框模式设置无模命令**

| 名称                               | 命令 | 描述                                                                                                                                                                                                                                                                                                                                                    |
|------------------------------------|------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 边框模式开/关                      | O    | 切换边框模式开和关。OH 和 OL 无模命令决定边框模式的分辨率模式。显示焊盘、走线和所有线的边框。走线以其真实宽度显示，受全局/常规选项中最小显示宽度设置的限制。另请参阅："[边框视图模式](/layout/guide/2_zh.md#21)"。                                                                                           |
...
| 名称          | 命令 | 描述                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|---------------|------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 快速测量      | Q    | 使用动态标尺快速测量。将光标放在起点，然后键入"q"无模命令。拖动光标在测量起点和终点之间创建一条线。当捕捉到网格开启时，捕捉到设计网格。当网格捕捉关闭时，测量无网格。动态报告当前设计单位中的 delta x、delta y 和 delta x,y。您还可以使用此命令测量极坐标网格节点之间的精确欧几里得距离。                                                                                                                                                                                                                                 |
|               |      | 快速测量模式也适用于对象捕捉。但除非您在对象类型的捕捉半径内，否则不会给您选择捕捉到网格或对象作为起点的选项。捕捉到对象类型优先于捕捉到网格。                                                                                                                                                                                                                                                                                                                                                                                       |
|               |      | 您可以在测量操作期间的弹出菜单、选项对话框或使用 OS 无模命令启用捕捉到对象。                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|               |      | 另请参阅："测量"。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 快速长度      | QL   | 快速长度。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
|                           | 命令 | 描述                                                                                                                                                                                                                                                                                                                                                                                                     |
|---------------------------|------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 基本日志测试              | BLT  | 基本日志测试。打开[日志测试对话框](/layout/guide/Dialogs/51_zh.md#9)。BLT 查找并运行 BMW 会话回放媒体。另请参阅：BMW 和 BLT                                                                                                                                                                                                                                                                                                                    |
| 打开基本媒体向导          | BMW  | 打开基本[媒体向导对话框](/layout/guide/Dialogs/51_zh.md#19)。• BMW 为有问题的 `SailWind Logic`、`SailWind Layout` 或 `SailWind Router` 会话记录会话回放媒体。它可以基于您上次 SailWind 会话或当前会话创建回放媒体。此回放媒体可以使用 BLT 无模命令回放。• BMW 也是命令行选项。另请参阅：BMW 和 BLT                                                                                                                                                   |
...
| 区域缩放进/出(拖动缩放)                 | MButton+ `<Start Drag>`区域缩放进或出。向上拖动鼠标放大。向下拖动鼠标缩小。                           |                                                                 |
| 从角落开始缩放                          | Shift+MButton+ `<Start Drag>`                                                                             | 从角落开始缩放。                                                |
| 缩放到选定                              | Alt+Z                                                                                                   | 缩放到选定。将选定对象适配到工作空间。                          |
| 缩放模式开/关                           | Ctrl+W                                                                                                  | 切换缩放模式开/关。                                             |
| 中心视图(使用鼠标位置)                  | MButton+`<Click>`                                                                                         | 以鼠标为中心视图。                                              |
|                                         | `<Insert>`                                                                                                |                                                                 |
| 在鼠标位置放大(缩放模式)                | LButton+`<Click>`                                                                                         | 在鼠标位置放大(缩放模式)。                                      |
|                                         | `<spacebar>`                                                                                              |                                                                 |
| 在鼠标位置缩小(缩放模式)                | RButton+`<Click>`                                                                                         | 在鼠标位置缩小(缩放模式)。                                      |
| 在鼠标位置放大                          | `<Page Up>`                                                                                               | 在鼠标位置放大。                                                |
|                                         | Ctrl+`<Rotate Forward>`                                                                                   |                                                                 |
| 在鼠标位置缩小                          | `<Page Down>`                                                                                             | 在鼠标位置缩小。                                                |
|                                         | Ctrl+`<Rotate Backward>`                                                                                  |                                                                 |
| 鼠标下移(一个设计网格)                  | `<Down Arrow>`鼠标向下移动一个设计网格。                                                              |                                                                 |
| 鼠标上移(一个设计网格)                  | `<Up Arrow>`                                                                                              | 鼠标向上移动一个设计网格。                                      |

**表 35. 平移、缩放和导航[键盘快捷键](#4)**

| 名称                                    | 快捷键                | 描述                                                                 |
|-----------------------------------------|----------------------|---------------------------------------------------------------------|
| 鼠标左移(一个设计网格)                  | `<Left Arrow>`         | 鼠标向左移动一个设计网格。                                          |
| 鼠标右移(一个设计网格)                  | `<Right Arrow>`        | 鼠标向右移动一个设计网格。                                          |
| 动态平移(拖动平移)                      | Alt+MButton+`<Start Drag>`     | 将鼠标下方的图纸区域平移到工作空间中心。                            |
...
| 名称                     | 快捷键                                                                              | 描述                    |
|--------------------------|------------------------------------------------------------------------------------|------------------------|
| [选择筛选条件](/layout/guide/4_zh.md#2)               | Ctrl+Alt+F                                                                         | 显示[选择筛选条件](/layout/guide/4_zh.md#2)。        |
| 选择                     | LButton+`<Click>`                                                                    | 选择对象。              |
| 选择                     | `<Spacebar>`                                                                         | 选择对象。              |
| 选择所有板对象           | Ctrl+A根据[选择筛选条件](/layout/guide/4_zh.md#2)选择设计中的所有对象。                                      |                         |
...
| 名称                           | 快捷键键 | 描述                      |
|--------------------------------|--------------|--------------------------|
| [创建新设计文件](/layout/guide/9_zh.md#1)(空白)           | Ctrl+N       | 创建新的空白设计文件。    |
| 打开文件(设计)                 | Ctrl+O       | 打开设计文件。            |
| 保存                           | Ctrl+S       | 保存设计文件              |

**表 38. 打开菜单和对话框[键盘快捷键](#4)**
...
| 显示颜色设置                                       | Ctrl+Alt+C    | 打开[显示颜色设置对话框](/layout/guide/Dialogs/48_zh.md#31)。                                                |
| 选项>`设计类别                                  | Ctrl+Alt+D    | 打开选项对话框的设计类别。                                              |
| 选项>`全局类别>`常规子类别                       | Ctrl+Alt+G    | 打开选项对话框的全局类别>`常规子类别。                               |
| 打开状态窗口                                       | Ctrl+Alt+S    | 打开状态窗口                                                            |
| 打开[查看网络对话框](/layout/guide/Dialogs/55_zh.md#23)                                 | Ctrl+Alt+N    | 打开[查看网络对话框](/layout/guide/Dialogs/55_zh.md#23)。                                                    |
...
| 完成布线                          | `<Enter>`               | 完成布线。                                                                                                                                                                                    |
| 完成                                  | LButton+`<Click>`       | 完成(交互式布线)当鼠标靠近有效                                                                                                                                                             |
...
| 名称                                                     | 快捷键 | 描述                                                                                                                  |
|----------------------------------------------------------|--------|----------------------------------------------------------------------------------------------------------------------|
| 激活右键弹出菜单(右键鼠标按钮)                       | M      | 激活当前模式的快捷菜单。与**右键**点击相同。                                                                          |
| 左键点击                                                 | `<Spacebar>`    | 在当前鼠标位置激活左键鼠标按钮点击(添加转角、选择项目、完成等)。                                              |

**表 45. SailWind 3D 中的平移、缩放和导航[键盘快捷键](#4)**
...
| 区域缩放进/出(拖动缩放)        | MButton+`<Start Drag>` | 区域缩放进或出。拖动鼠标向上放大。拖动鼠标向下缩小。                    |
| 缩放到选定          | Alt+Z           | 缩放到选定。适配选定对象到工作空间。                         |
| 中心视图(使用       | MButton+`<Click>`         | 以鼠标为中心视图。                                              |
| 鼠标位置)           | `<Insert>`                |                                                                 |
| 缩小                | `<Page Down>`             | 在鼠标位置缩小。                                                |
| 放大                | `<Page Up>`               | 在鼠标位置放大。                                                |
| 在鼠标位置缩小      | Ctrl+`<Rotate Backward>`  | 在鼠标位置缩小。                                                |
| 在鼠标位置放大      | Ctrl+`<Rotate Forward>`   | 在鼠标位置放大。                                                |
| 拖动平移            | Alt+MButton+`<StartDrag>` | 板向拖动方向相反方向移动。                                   |


**表 46. SailWind 3D 中管理 3D 视点的[键盘快捷键](#4)**
...
**表 47. SailWind 3D 中的文件操作[键盘快捷键](#4)**

| 名称                              | 快捷键 | 描述                |
|-----------------------------------|--------|--------------------|
| [创建新设计文件](/layout/guide/9_zh.md#1)(空白)          | Ctrl+N | [创建新设计文件](/layout/guide/9_zh.md#1)。    |
| 打开文件(设计)                    | Ctrl+O | 打开设计文件。      |
| 保存                              | Ctrl+S | 保存设计文件。      |

**表 48. SailWind 3D 中打开菜单和对话框的[键盘快捷键](#4)**
...
**表 49. SailWind 3D 中的放置操作[键盘快捷键](#4)**
