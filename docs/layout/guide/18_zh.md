...
1. 创建属性。您可以使用属性辞典创建属性。您还可以使用[对象属性对话框](/layout/guide/Dialogs/51_zh.md#31)创建属性并将其分配给对象；但是，您无法通过此对话框修改属性的属性。因此，最好在属性辞典中创建所有属性。定义属性特性。您必须设置属性应具有的值类型、要分配属性的设计对象以及属性的层级。有关更多信息，请参阅“[为设计创建属性](#6)”主题。

2. 将属性分配给设计中的对象。有关更多信息，请参阅“[设计对象属性](#10)”主题。

3. 您可以将属性分配给多个类型的多个对象。有关更多信息，请参阅鼠标“[属性管理器](#9)”主题。
...
| IDF            | 默认属性 Geometry.Height 会自动导出到 IDF。此属性取代了早期版本中使用的 ZHEIGHT 功能。有关更多信息，请参阅“[导出 IDF 文件](/layout/guide/13_zh.md#12)”。 |
...
尽管您可以使用[对象属性对话框](/layout/guide/Dialogs/51_zh.md#31)（选择对象 > **右键**点击 > **属性**）向设计对象添加新属性，但必须使用属性辞典来设置属性值的属性。
...
您可以使用[属性辞典对话框](/layout/guide/Dialogs/46_zh.md#43)将元件类型和封装的属性从当前库自动加载到 PCB 设计中。您可以在打开文件时加载属性，也可以在打开文件后加载属性。加载属性时，会发生以下操作：
...
有关更多信息，请参阅“[属性辞典对话框](/layout/guide/Dialogs/46_zh.md#43)”主题。

### 默认和其他属性特性及用法 ಠ_ಠ \{#5-1}

`SailWind Layout` 提供了可用于每个设计的默认属性。您可以更改默认属性辞典以匹配库属性或满足其他设计需求。

有关更多信息，请参阅“修改设计属性”和“[修改默认属性辞典](#5-2)”主题。
...
| DFT.Use Via Grid                        | 指示在添加和[放置测试点](/layout/guide/39_zh.md#1-6)时是否使用过孔网格。                                            |
...
| Strategy.Fanout.PlanePriority | 指示扇出通行的[平面网络布线](/layout/tutorial/7_zh.md#6)顺序。                                                  |
...
| Strategy.Patterns.PlanePriority | 指示模式通行的[平面网络布线](/layout/tutorial/7_zh.md#6)顺序。                                 |
...
| Strategy.Route.PlanePriority    | 指示布线通行的[平面网络布线](/layout/tutorial/7_zh.md#6)顺序。                                    |
...
| Strategy.Optimize.PlanePriority | 指示优化通行的[平面网络布线](/layout/tutorial/7_zh.md#6)顺序。                                 |
...
| Strategy.Miters.PlanePriority    | 指示斜接通行的[平面网络布线](/layout/tutorial/7_zh.md#6)顺序。                                     |
...
当您创建新文件或导入旧文件时，相应的 ASCII 文件会自动导入。更多信息请参阅"文件打开转换"和"[属性辞典对话框](/layout/guide/Dialogs/46_zh.md#43)"。
...
4. 根据需要修改现有属性或添加属性。更多信息请参阅"[修改设计属性特性](#7)"

5. 点击**确定**关闭对话框

6. 要覆盖现有文件，点击**主页>导出**菜单项。执行此操作可更改 *default.asc* 或*DefaultAttributeDictionary.asc* 文件。如果要创建仅用于新文件的启动文件，请转至步骤 10

7. 选择**ASCII**作为文件类型并点击**保存**。将显示 [ASCII 输出对话框](/layout/guide/Dialogs/46_zh.md#31)

8. 在 Sections 列表中，选中 Attributes 复选框

9. 点击**确定**。默认属性辞典将被替换

10. 要创建新的启动文件，请按照"[创建启动文件](/layout/guide/10_zh.md#2)"中描述的步骤操作。确保在[启动文件输出对话框](/layout/guide/Dialogs/54_zh.md#32)中选中 Attributes 复选框。将创建一个新的启动文件，可用于所有新设计

### 属性分配 ಠ_ಠ \{#5-3}

如果无法选择要分配属性的对象，请选择相关对象。

下表定义了对象之间的关系。更多信息请参阅鼠标"将属性值应用于所有其他对象"和鼠标"[属性管理器](#9)"主题，了解如何分配给相同对象类型和多个对象类型。
...
- 在属性辞典中将属性定义为自由文本类型。当您想要利用[属性管理器对话框](/layout/guide/Dialogs/46_zh.md#44)中的数学函数时，请转到属性辞典并将类型更改为 Number、Decimal Number 或 Measure。然后，在执行比较或开始 `ECO` 之前，将类型设置回自由文本。
...
使用自由文本类型时，可以选择区分大小写参数来保留自由文本条目的字母大小写。此设置会影响[查找对话框](/layout/guide/Dialogs/49_zh.md#15)和[属性管理器对话框](/layout/guide/Dialogs/46_zh.md#44)中的排序和匹配。
...
2. 在[属性辞典对话框](/layout/guide/Dialogs/46_zh.md#43)中，点击**新建**

3. 在属性特性对话框，在属性文本框中输入要创建的新属性名称
...
7. 在对象标签页，为要应用属性的对象分配设置和层次结构

8. 点击**确定**关闭属性特性对话框

9. 点击**关闭**关闭[属性辞典对话框](/layout/guide/Dialogs/46_zh.md#43)

👀‍**结果**

列表框中包含您输入的属性可能值。列表中的项目显示为列表，可以在对象属性或[属性管理器对话框](/layout/guide/Dialogs/46_zh.md#44)中选择值。
...
2. 在[属性辞典对话框](/layout/guide/Dialogs/46_zh.md#43)中选择包含要删除列表条目的属性
...
7. 点击 **关闭** 关闭[属性辞典对话框](/layout/guide/Dialogs/46_zh.md#43)

#### 测量属性类型 \{#5-5-4}

*[测量属性类型](#5-5-4)* 是与单位相关的物理值，允许您确定属性值的测量值。

##### 创建测量类型属性

您可以选择[测量属性类型](#5-5-4)来设置属性值的测量参数。这是与单位相关的物理值。

可以[设置测量单位](/layout/tutorial/1_zh.md#3)，并为值设置最小值和最大值。可以从预定义列表中选择测量单位，也可以添加新单位。还可以自定义单位。可以使用现有测量单位，也可以为设计添加新的测量单位。
...
2. 在[属性辞典对话框](/layout/guide/Dialogs/46_zh.md#43)中点击**新建**
...
4. 在**类型**标签页选择测量类型并执行以下操作：
   ...
   - 在单位框输入单位名称
     ...
     > [!tip]
     >
     > 如果使用单位 Mil，请在电路板级别分配属性，否则当您更改设计单位时(使用选项对话框>**全局**类别>常规子类别)，单位不会改变。
...
2. 在[属性辞典对话框](/layout/guide/Dialogs/46_zh.md#43)中选择包含要删除测量项目的属性
...
8. 在对象标签页为要应用属性的对象分配设置和层次结构

9. 点击**确定**接受限制并关闭属性特性对话框

10. 点击**关闭**关闭[属性辞典对话框](/layout/guide/Dialogs/46_zh.md#43)
...
6. 完成属性特性设置后，点击**确定**返回[属性辞典对话框](/layout/guide/Dialogs/46_zh.md#43)
...
2. 在[属性辞典对话框](/layout/guide/Dialogs/46_zh.md#43)中从列表中选择要修改的属性。默认属性和设计属性会列出。可以从组列表中选择属性组来筛选视图，仅显示特定组的属性。如果属性是结构化属性，则会分组。

   > !tip] 如果选择显示隐藏复选框，可以查看没有可见属性的属性组。可以在[属性特性对话框的**对象**标签页设置属性是否隐藏。
...
4. 在属性特性对话框点击**类型**标签页，然后点击属性的类型。

   > [!danger]
   >
   > 如果使用设计单位 Mil，请在电路板级别分配属性，否则当您更改设计单位时(使用选项对话框>**全局**类别>常规子类别)，单位不会改变。

5. 点击对象标签页，点击要限制的对象。不能将属性分配给受限对象

6. 要使用默认层次结构，点击使用默认层次结构复选框

7. 如果要启用属性的 `ECO` 注册，点击 **ECO已注册**复选框

8. 完成属性特性设置后点击**确定**返回[属性辞典对话框](/layout/guide/Dialogs/46_zh.md#43)
...
2. 在[属性辞典对话框](/layout/guide/Dialogs/46_zh.md#43)从列表中选择要删除的属性。可以从组列表中选择属性组来筛选视图，仅显示特定组的属性。如果属性是结构化属性，则会分组。清除显示隐藏复选框可筛选列表，仅显示至少包含一个可见属性的属性组。
...
使用[属性管理器](#9)查看设计中所有对象所有属性的电子表格。

可以使用[属性管理器](#9)添加、编辑和删除多种对象类型的属性值。还可以创建基于分配给同一类型对象每个属性值的属性值摘要。换句话说，摘要按属性应用，并应用于同一标签页上的所有对象。

> [!danger]
>
> 隐藏属性对[属性管理器](#9)不可用，也不会显示在[显示属性对话框](/layout/guide/Dialogs/54_zh.md#27)中。

> [!warning]
>
> 如果属性是只读，多列列表中的行不可用。如果属性已 `ECO` 注册且 `SailWind Layout` 不处于 `ECO` 模式，行也不可用。隐藏属性不会出现在列表中。所有对象都会出现在多列列表中，无论它们是否分配了属性。未分配属性的对象在属性名称下的单元格中显示<none>。分配了属性但没有值的对象在属性名称下的单元格中显示空白。


> [!tip] 可以通过将属性放置在文档层上来避免 `DRC` 违规或短路。如果属性显示在设计中的电气层上，它将在制造文档中显示为铜。将自由文本和属性值放置在丝印顶层或其他文档层上。

[列出设计对象](#9-1) [选择要在属性管理器中列出的属性](#9-2) [使用属性管理器为设计对象添加属性值](#9-3) [使用属性管理器修改属性值](#9-4) [删除属性值](#9-5) 将属性值应用于所有其他对象 创建摘要

### 列出设计对象 \{#9-1}

[属性管理器](#9)的多列列表编录设计对象及其分配的属性。对象显示在左列，属性名称显示在列标题中。

🏃‍♂️‍**步骤**

1. 点击**编辑>[属性管理器](#9)**菜单项
2. 在[属性管理器对话框](/layout/guide/Dialogs/46_zh.md#44)的查看区域点击视图选项：
   - **已选定** 列出设计中选定对象的属性
...
使用[显示属性对话框](/layout/guide/Dialogs/54_zh.md#27)选择要在[属性管理器](#9)多列列表中列出的属性。

🏃‍♂️‍**步骤**

1. 点击**编辑>[属性管理器](#9)**菜单项

2. 在[属性管理器对话框](/layout/guide/Dialogs/46_zh.md#44)中点击**显示**

3. 在"[显示属性对话框](/layout/guide/Dialogs/54_zh.md#27)"，在组列表中选择属性组或 `<all>` 选择所有属性
...
在[属性管理器](#9)中，可以为尚未分配属性的一个或多个对象添加属性和值。可以为包含`<none>`的单元格添加值，这意味着属性对设计可用但尚未分配给对象。

只能为设计可用的属性添加属性值。要为设计对象创建新属性，请参阅"[为设计创建属性](#6)"。可以在值中包含单位。`SailWind Layout` 还提供一组默认单位(和单位前缀)作为输入和输出使用。更多信息请参阅"默认单位"。

🙊**限制**

不能添加隐藏属性、只读属性或不在 `ECO` 模式时添加 [`ECO` 注册属性](/layout/guide/36_zh.md#6)。

🏃‍♂️‍**步骤**

1. 点击**编辑>[属性管理器](#9)**菜单项

2. 在[属性管理器对话框](/layout/guide/Dialogs/46_zh.md#44)中选择包含`<none>`的单元格

3. 点击**添加**

4. 在单元格中输入值并按 Enter 键

   > !tip] 只能为设计可用的属性[添加属性值。要为设计对象创建新属性，请参阅"[为设计创建属性](#6)"。可以在值中包含单位。`SailWind Layout` 还提供一组默认单位(和单位前缀)作为输入和输出使用。更多信息请参阅"默认单位"。

### 使用属性管理器修改属性值 \{#9-4}

在[属性管理器](#9)中，可以编辑空白属性值单元格或包含值的单元格。如果单元格为空白，表示分配的属性没有值。

🙊**限制**

不能编辑只读属性或不在 `ECO` 模式时编辑 [`ECO` 注册属性](/layout/guide/36_zh.md#6)。

🏃‍♂️‍**步骤**

1. 点击**编辑>[属性管理器](#9)**菜单项

2. 在[属性管理器对话框](/layout/guide/Dialogs/46_zh.md#44)中选择空白单元格或包含值的单元格
...
在[属性管理器](#9)中，您可以从设计对象中删除属性及其值。

> !danger] 您无法删除只读属性，或在非 `ECO` 模式下删除 [[`ECO` 注册属性](/layout/guide/36_zh.md#6)。

🏃‍♂️‍**步骤**

1. 点击菜单项 **编辑 > [属性管理器](#9)**。

2. 在[属性管理器对话框](/layout/guide/Dialogs/46_zh.md#44)中，选择包含值的单元格。

3. 点击 **删除**。

   系统将显示消息“确定要[删除属性值](#9-5) <属性名称>: <属性值> 吗？”。
...
在[属性管理器](#9)中，您可以将一个对象的属性值应用到所有同类型的其他对象。换句话说，您可以为所有同类型的对象设置相同的属性值。现有值将保持不变。

🏃‍♂️‍**步骤**

1. 点击菜单项 **编辑 > [属性管理器](#9)**。

2. 在[属性管理器对话框](/layout/guide/Dialogs/46_zh.md#44)中，点击要应用到其他对象的属性值所在的单元格。
...
- 隐藏属性对[属性管理器](#9)不可用，且不会显示在“显示属性”对话框中。

🏃‍♂️‍**步骤**

1. 点击菜单项 **编辑 > [属性管理器](#9)**。

2. 在[属性管理器对话框](/layout/guide/Dialogs/46_zh.md#44)中，点击 **显示**。

   > !warning] 属性必须在[[属性管理器](#9)中被选中才能查看。更多信息，请参阅“选择属性以在[属性管理器](#9)中列出”。

3. 在“[显示属性对话框](/layout/guide/Dialogs/54_zh.md#27)”中，从属性列表中选择一个属性。

4. 为每种属性类型选择要创建的摘要类型的复选框。

5. 点击 **确定** 返回[属性管理器对话框](/layout/guide/Dialogs/46_zh.md#44)。
...
使用可调整大小的[对象属性对话框](/layout/guide/Dialogs/51_zh.md#31)添加、修改或删除单个对象或同类型多个对象的属性。


> [!danger] 如果属性为只读，多列列表中的行将不可用。如果属性为 `ECO` 注册且 `SailWind Layout` 未处于 `ECO` 模式，行也将不可用。


> [!warning] 
> 通过将属性放置在文档层上，可以避免 `DRC` 违规或短路问题。如果属性显示在设计中的电气层上，它将在制造文档中显示为铜。将自由文本和属性值放置在丝印顶层或其他文档层上。
> 
> [通过对象属性对话框为设计对象分配属性](#10-1) [修改属性值](#10-2) 移除属性 移除属性值 [为设计组件和跳线添加高度信息](#10-5) [为设计中的所有对象添加属性](#10-6)

### 通过对象属性对话框为设计对象分配属性 \{#10-1}

您可以使用[对象属性对话框](/layout/guide/Dialogs/51_zh.md#31)为对象或同类型的多个对象分配属性。

例如，您可以选择多个元件并分配属性，但不能同时选择元件和过孔并分配属性。[对象属性对话框](/layout/guide/Dialogs/51_zh.md#31)仅显示适用于所选对象的属性。
...
2. 右键点击并选择 **属性**。
   ...
   “[对象属性对话框](/layout/guide/Dialogs/51_zh.md#31)”将打开。更多信息，请参阅“[通过对象属性对话框为设计对象分配属性](#10-1)”。

3. 从“组”列表中点击要查看的属性组。如果分配了多个属性且其中一些是结构化属性，此列表将作为过滤器，允许您选择要查看的属性组。
...
6. 从“属性”列表中选择一个属性，或在空白单元格中输入新属性的名称。无法添加隐藏或只读属性。属性名称最长可为 255 个字符。可以使用任何可打印字符（包括空格）作为属性名称，但空格不能作为名称的第一个或最后一个字符。属性名称不区分大小写，且在整个设计中定义，而非按对象定义。
...
8. 点击 **关闭** 以关闭[对象属性对话框](/layout/guide/Dialogs/51_zh.md#31)。

   > [!tip] 可以多次添加相同的属性，只要将其添加到属性层级的不同级别即可。

### 修改属性值 \{#10-2}

您可以使用[对象属性对话框](/layout/guide/Dialogs/51_zh.md#31)修改对象或同类型多个对象的属性值。当选择多个对象修改属性时，“属性”列表将显示所有属性名称的并集。
...
1. 如果属性为 `ECO` 注册，请进入 `ECO` 模式。点击 [`ECO` 工具栏](/layout/guide/36_zh.md#2)按钮进入 `ECO` 模式。如果未先进入 `ECO` 模式，系统将显示消息提示您需要进入 `ECO` 模式。

   > [!danger] 
   > 无法修改只读属性。

   > 更多信息，请参阅“[`ECO` 选项对话框](/layout/guide/Dialogs/49_zh.md#1)”。

2. 选择要修改的对象。

3. 右键点击并选择 **属性**。

   选定对象的属性信息将以电子表格形式显示在“[对象属性对话框](/layout/guide/Dialogs/51_zh.md#31)”中。

4. 从“组”列表中点击要查看的属性组。如果分配了多个属性且其中一些是结构化属性，此列表将作为过滤器，允许您选择要查看的属性组。
...
您可以使用[对象属性对话框](/layout/guide/Dialogs/51_zh.md#31)移除对象或同类型多个对象的属性。只能删除当前层级的属性。如果删除属性且在层级中更高层级存在该属性的值，则该值将应用于当前层级。

要从设计中完全删除属性，请使用属性辞典。

🏃‍♂️‍**步骤**

1. 如果属性为 `ECO` 注册，请进入 `ECO` 模式。

   点击 **[`ECO` 工具栏](/layout/guide/36_zh.md#2)** 按钮进入 `ECO` 模式。[`ECO` 选项对话框](/layout/guide/Dialogs/49_zh.md#1)将出现。如果未先进入 `ECO` 模式，系统将显示消息提示您必须进入 `ECO` 模式。

   > [!tip] 无法编辑只读属性。

2. 选择要编辑的对象。

3. 右键点击并选择 **属性**。“[对象属性对话框](/layout/guide/Dialogs/51_zh.md#31)”将出现。选定对象的属性信息将以电子表格形式显示在列表中。

4. 从“组”列表中点击要查看的属性组。如果分配了多个属性且其中一些是结构化属性，此列表将作为过滤器，允许您选择要查看的属性组。

5. 点击要[删除属性值](#9-5)的单元格。
...
您可以使用[对象属性对话框](/layout/guide/Dialogs/51_zh.md#31)移除对象或同类型多个对象的属性值。

🏃‍♂️‍**步骤**

1. 如果属性为 `ECO` 注册，请进入 `ECO` 模式。点击 **[`ECO` 工具栏](/layout/guide/36_zh.md#2)** 按钮进入 `ECO` 模式。[`ECO` 选项对话框](/layout/guide/Dialogs/49_zh.md#1)将出现。如果未先进入 `ECO` 模式，系统将显示消息提示您必须进入 `ECO` 模式。
...
> !tip] 要快速为多个对象添加高度信息，请使用“通过[[属性管理器](#9)为设计对象添加属性值”中的步骤。
...
3. 在[对象属性对话框](/layout/guide/Dialogs/51_zh.md#31)中，点击 **添加** 按钮。
...
1. 在设计中选择一个对象（例如组件、组件焊盘、网络或过孔），右键点击并选择 **属性**。
