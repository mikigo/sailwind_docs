...
您可以通过多种不同的方式与设计环境交互来控制设计视图。SailWind Logic 提供了一套全面的命令，让您能够在设计中[平移和缩放](/layout/tutorial/1_zh.md#5)，包括使用鼠标按钮/滚轮、[键盘快捷键](/layout/guide/3_zh.md#4)以及“视图”菜单上的各种选项。
...
- 单击视图 > 全局查看菜单项来调整视图大小以显示设计中的所有对象。
- 使用滚动条平移视图。

### 鼠标中键 \{#1-2}

您可以[使用鼠标中键](/layout/guide/22_zh.md#2-3)执行多项查看操作。

[使用鼠标中键](/layout/guide/22_zh.md#2-3)执行[平移和缩放](/layout/tutorial/1_zh.md#5)操作：
...
有关详细信息，请参阅[使用数字键盘控制视图](/logic/guide/2_zh.md#8)。
...
[项目浏览器](/layout/guide/2_zh.md#12)以层次结构列出设计中的对象。更新设计时，层次结构也会自动更新。

>  [!WARNING]
>
> [项目浏览器](/layout/guide/2_zh.md#12)在元件编辑器中不可用。

>  [!INFO]
>
> 要打开[项目浏览器](/layout/guide/2_zh.md#12)，请单击[项目浏览器](/layout/guide/2_zh.md#12)按钮。

您可以配置[项目浏览器](/layout/guide/2_zh.md#12)，以便您可以单击列出的对象在工作区中选择它，或者选择它并放大到它。

🏃‍♂️‍**步骤**

1. 在[项目浏览器](/layout/guide/2_zh.md#12)中**右键**单击，然后单击“允许选择”菜单项。
...
- [状态选项卡](/layout/guide/2_zh.md#14)— 显示有关当前会话的信息。
- 宏选项卡 — 使您能够运行、编辑和调试脚本。
...
“状态”选项卡中的[会话日志文件](/layout/guide/45_zh.md#3)消息按主题采用颜色编码。带下划线的项目表示链接。颜色代码如下表所示：
...
2. 在“宏”选项卡中**右键**单击，然后单击“切换断点”，或者在“宏”选项卡工具栏上单击“切换断点”按钮。
   ...
   当宏引擎在播放宏时遇到断点时，它会暂停宏。宏中的下一行将用指令鼠标进行标记。
...
如果发生运行时错误，宏调试器将切换到逐步模式，并在状态栏上显示详细信息。指令鼠标将指向产生错误的行。修复错误后，您可以继续播放宏。
