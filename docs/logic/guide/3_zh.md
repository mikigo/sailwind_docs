...
您可以通过多种不同的方式与设计环境交互来控制设计视图。SailWind Logic 提供了一套全面的命令，让您能够在设计中[平移和缩放](/logic/tutorial/2_zh.md#3)，包括使用鼠标按钮/滚轮、键盘快捷键以及“视图”菜单上的各种选项。
...
使用鼠标中键执行[平移和缩放](/logic/tutorial/2_zh.md#3)操作：
...
[项目浏览器](#2)以层次结构列出设计中的对象。更新设计时，层次结构也会自动更新。
...
>  [!INFO]
>
> 要打开[项目浏览器](#2)，请单击[项目浏览器](#2)按钮。

您可以配置[项目浏览器](#2)，以便您可以单击列出的对象在工作区中选择它，或者选择它并放大到它。

🏃‍♂️‍**步骤**

1. 在[项目浏览器](#2)中**右键**单击，然后单击“允许选择”菜单项。
...
“状态”选项卡中的[会话日志文件](/logic/guide/23_zh.md#3)消息按主题采用颜色编码。带下划线的项目表示链接。颜色代码如下表所示：
