...
1. 在原理图编辑器中，点击工具 > 选项。
2. 在[选项对话框](/logic/guide/24_zh.md#78)中，选择适当的类别 - 上的“常规”、上的“设计”、上的“文本”或上的“线宽”。另请参阅设置字体。
3. 设置您想要更改的选项。
4. 点击另一个类别来设置其选项。
5. 完成选项设置后，点击“确定”。
...
SailWind Logic 会根据您选择的设置自动[创建备份文件](#1-2)。您可以选择备份间隔、文件命名、所需的备份文件数量以及存储位置。
...
4. 执行以下操作之一：
   ...
   - 点击“备份文件”以更改备份文件的文件夹或名称，然后在“备份文件”对话框中浏览到该文件夹，键入文件名，然后点击“保存”。
   - 选中“在备份文件名中使用设计名称”复选框，使用设计名称而不是产品名称作为文件名，例如 preview\_logic1.sch、preview\_logic2.sch 而不是 logic1.sch、logic2.sch。

5. 选中“在设计目录中[创建备份文件](#1-2)”复选框，将所有备份文件放在与设计相同的目录中。

   > [!TIP]
   >  如果您希望将备份文件放在一个公共备份目录中，请点击清除。
...
| 如果选择此项：           | 备份文件已保存             |                                  |
| ------------------------ | -------------------------- | -------------------------------- |
| 在设计目录中[创建备份文件](#1-2) | 在备份文件名中使用设计名称 |                                  |
|                          |                            | 在没有设计名称的一个公共目录中。 |
| X                        | X                          | 在设计目录中使用设计名称。       |
| X                        |                            | 在没有设计名称的设计目录中。     |
|                          | X                          | 在一个使用设计名称的公共目录中   |
...
1. 在原理图编辑器中，点击工具 > 元件编辑器。
2. 在元件编辑器中，点击编辑 > [CAE 封装](/logic/guide/7_zh.md#7)编辑器。
3. 在 [CAE 封装](/logic/guide/7_zh.md#7)编辑器中，点击工具 > 选项。
4. 在[选项对话框](/logic/guide/24_zh.md#78)中，选择适当的类别 - 鼠标常规、鼠标文本或鼠标线宽。另请参阅设置字体。
5. 设置您想要更改的选项。
6. 点击另一个类别来设置其选项。
7. 如果要将设置的选项保存为创建新元件的默认选项，请点击**“另存为默认值”**按钮。
   ...
   | 从[选项对话框](/logic/guide/24_zh.md#78)常规类别 | 来自[选项对话框](/logic/guide/24_zh.md#78)文本类别 | 从设置菜单 > [字体对话框](/logic/guide/24_zh.md#56) |
   | --- | --- | --- |
...
2. 在选项区域中，选中“粘贴时[保留参考编号](#1-4)”复选框以保留组参考编号。
...
使用“选项”对话框中的“常规”类别设置显示网格，或使用上的“GD 无模命令”。如果不想显示显示网格，请将其设置为 10。
...
要在元件编辑器中设置原点，请从菜单中选择鼠标“设置/设置原点”。将光标定位到您想要的新原点位置，然后点击。
...
6. 要将颜色分配保存到文件，请点击“保存”，然后在“保存配置”对话框中键入配置名称。
...
7. 要更改默认调色板，请完成“选定颜色”区域的修改，然后点击“保存”。在“保存配置”对话框中键入“默认”以覆盖现有的默认配置，然后点击“确定”。
...
1. 点击“设置 > 字体。
2. 在“字体”对话框中，选择“描边”以在设计中使用描边字体，然后点击“确定”。
...
4. 点击所需字体样式的按钮：B 表示粗体，I 表示斜体，U 表示下划线。
...
1. 点击工具 > 选项，然后点击文本类别。
2. 要更改文本项的大小或宽度，请选择文本类型并点击**“编辑”**按钮，然后在大小或宽度列表中键入以密耳为单位的新值。

   > [!TIP]
   >
   > 您必须选择一种类型并点击要更改的每个属性的“编辑”按钮；您不能同时编辑大小和宽度。

3. 完成更改后，点击“确定”。

### 设置系统字体选项 \{#3-3}

您可以[设置系统字体选项](#3-3)来控制设计中文本对象的显示方式。您可以选择所选字体的字体样式、大小和其他视觉特性。

🏃‍♂️‍**步骤**

1. 点击工具 > 选项，然后点击文本类别。
2. 要更改某种文本的字体，请选择一种文本类型并点击**“编辑”**按钮，然后从列表中选择所需的字体。
...
4. 要更改文本大小，请选择要更改的类型的“大小”框，点击**“编辑”**按钮，然后键入新值。
...
1. 点击工具 > 选项，然后点击线宽类别。
2. 选择一种线型并点击**“编辑”**按钮，然后在“宽度”列中，以密耳为单位输入所需尺寸的新值。
3. 完成更改后，点击“确定”。
...
2. 在字体列中，选择要替换的字体的名称。
   ...
   > [!INFO]
   >
   > 如果只需要替换一种字体，则只显示一种字体；点击该框没有任何效果。
