...
1. 在元件编辑器的工具栏上，点击**打开**按钮。

2. 在[选择编辑项目类型对话框](/logic/guide/24_zh.md#124)中，点击**接地**，然后点击**确定**。
...
4. 点击“添加”。这样就会为该符号创建一个新的条目。
   ...
   > [!TIP]
   >
   > 要添加新的地面符号，请按照[创建新的特殊符号](#5)中的步骤进行操作。

5. 在“特殊符号”列中，点击新建文本框右侧的按钮。此时将出现上的“浏览特殊符号”对话框。

6. 要过滤符号，请在项目框中键入上的通配符或表达式，然后点击应用。
...
> [!INFO]
>
> 有关特殊原理图符号的创建和使用的更多信息，请参阅上的“特殊原理图符号”。

🏃‍♂️‍**步骤**

1. 在元件编辑器的工具栏上，点击打开按钮。
2. 在“选择编辑项类型”对话框中，点击“页间连接符”，然后点击“确定”。将显示当前符号。
1. 在元件编辑器的工具栏上，点击**打开**按钮。
2. 在“选择编辑项类型”对话框中，点击“页外连接符”，然后点击“确定”。将显示当前符号。
3. 点击“编辑电参数”按钮。
4. 点击“添加”。这样就会为该符号创建一个新的条目。
...
5. 在“特殊符号”列中，点击新建文本框右侧的按钮。将出现鼠标“浏览特殊符号”对话框。
6. 要过滤符号，请在项目框中键入上的通配符或表达式，然后点击应用。
7. 选择符号封装。
8. 点击“确定”。
...
2. 在“选择编辑项类型”对话框中，点击“电源”，然后点击“确定”。将显示当前符号。
...
4. 点击“添加”。这样就会为该符号创建一个新的条目。
   ...
   > [!TIP]
   >
   > 要添加新的电源符号，请按照[创建新的特殊符号](#5)中的步骤操作。
   
5. 在“特殊符号”列中，点击新建文本框右侧的按钮。此时将出现上的“浏览特殊符号”对话框。

6. 要过滤符号，请在“项目”框中键入上的“通配符或表达式”，然后点击“应用”。
...
3. 点击“确定”。当前定义的符号将显示所选类型。

4. 点击编辑 > 元件类型编辑器，或在工具栏上点击编辑电参数按钮。将出现特殊符号类型的分配替代符号对话框。有关更多信息，请参阅以下主题：

     - 页间连接符 — 请参阅为页外元件分配替代符号。

     - 电源符号——请参阅[为电源部分分配替代符号](#4)。
     - 接地符号——请参阅[为接地部分分配替代符号](#2)。
...
8. 点击“编辑 > [CAE 封装](/logic/guide/7_zh.md#7)编辑器，或在工具栏上点击“[CAE 封装](/logic/guide/7_zh.md#7)编辑器”按钮。将出现“选择管脚封装”对话框。

9. 选择新的符号名称，出现提示时点击“确定”以创建新符号。

10. 点击封装编辑工具栏按钮，点击创建二维线按钮，然后**右键**点击并使用可用的命令来创建符号。
...
13. 点击主页 > 保存。
    ...
    > [!TIP]
    >
    > 如果显示“将元件类型保存到库”对话框，请接受默认值并点击“确定”。
...
1. 执行以下操作之一：
   ...
   - 复制现有的特殊符号
     ...
     a. 在库管理器（主页 > 库菜单项）中，点击逻辑按钮。

     b. 要过滤符号，请在“筛选条件”框中键入上的通配符或表达式，然后点击“应用”。另请参阅特殊符号命名约定。

     c. 点击“复制”。将显示“将 [CAE 封装](/logic/guide/7_zh.md#7)保存到库”对话框。

      >    [!TIP]
      >
      >    如果“库”列表设置为“所有库”，则无法复制。（库名称列在 [CAE 封装](/logic/guide/7_zh.md#7)列表中的项目之前。）双击符号进入库，然后点击“复制”。
    ...
    - 修改现有的特殊符号
      ...
      b. 要过滤符号，请在项目框中键入上的通配符或表达式，然后点击应用。
   
      c. 在 [CAE 封装](/logic/guide/7_zh.md#7)区域中选择符号。
   
      d. 点击“编辑”。
   
      > [!TIP]
      >
      > 如果“库”列表设置为“所有库”，则“编辑”不可用。（库名称列在 [CAE 封装](/logic/guide/7_zh.md#7)列表中的项目之前。）双击符号进入库，然后点击“编辑”。
   
      e. 最小化[库管理器对话框](/logic/guide/24_zh.md#64)或将其移到一侧。
...
SailWind Logic 更新符号并生成上的“从库更新”报告。
