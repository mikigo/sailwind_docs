...
## 设置默认间距规则 \{#2}
您可以为设计[规则层次结构](/logic/guide/16_zh.md#7)的每个级别定义间距、布线和高速规则。



间距[规则对话框](/logic/guide/24_zh.md#111)的间距区域包含 PCB 设计数据矩阵。您可以为矩阵中的每个或所有数据类型指定值。
...
1. 在[规则对话框](/logic/guide/24_zh.md#111)中，点击**布线**按钮
2. 在选定层列表中，选择**地平面**，按住**Ctrl**键点击**电源平面**添加到选择中
3. 点击**移除**禁止在平面层上布线
4. 点击**确定**关闭[布线规则对话框](/logic/guide/24_zh.md#110)
5. 点击**关闭**关闭[默认规则对话框](/logic/guide/24_zh.md#47)

## 设置网络间距规则 \{#3}
您可以为网络分配特定的间距，这些间距将覆盖之前输入的默认规则。

1. 在[规则对话框](/logic/guide/24_zh.md#111)中，点击**网络**按钮
...
7. 点击**确定**完成定义
8. 关闭[网络规则对话框](/logic/guide/24_zh.md#75)

## 设置条件规则 \{#4}
当两个网络之间需要特定间距时（以避免对电路产生不利影响），必须定义条件规则。

1. 在[规则对话框](/logic/guide/24_zh.md#111)中，点击**条件规则**按钮
2. 在源规则对象区域，点击**网络**
3. 选择网络  **+5V** 
4. 在目标规则对象区域，点击**网络**
5. 选择网络  **+12V** 
