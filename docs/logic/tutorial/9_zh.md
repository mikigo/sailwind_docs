...
1. **文件**菜单 > **报告**
2. 在[报告对话框](/logic/guide/24_zh.md#109)中，选择**网络统计**复选框
...
1. **文件**菜单 > **报告**
2. 在[报告对话框](/logic/guide/24_zh.md#109)中，选择**未使用**复选框
...
3. 点击**设置**
4. 在[物料清单设置对话框](/logic/guide/24_zh.md#27)中，点击**属性**选项卡
5. 在字段标题列中，双击**Reference**
6. 在框中输入**Ref Des**并按**Enter**
7. 在宽度列中，双击 Part Name 旁边的值**15**
8. 在框中输入**12**作为新列宽并按**Enter**
9. 点击**确定**
10. 在[报告对话框](/logic/guide/24_zh.md#109)中点击**确定**。BillOfMaterials.ref 文件链接出现在输出窗口中
11. 检查[物料清单报告](/logic/guide/17_zh.md#2)内容，然后关闭报告
12. 不要保存文件副本
