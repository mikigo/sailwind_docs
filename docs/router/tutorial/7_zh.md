...
4. 点击 **确定** 应用更改并关闭[查看网络对话框](/router/guide/24_zh.md#83)。**结果：** 网络更新后的显示表明平面网络长度未最小化。
...
SailWind Router 有多种[自动布线设计](/router/guide/17_zh.md#7)的方法。您可以选择元件、网络或管脚并对选定对象应用自动布线传递类型（如扇出、布线或优化），或者使用自动布线命令自动布线整个设计。
...
除了[选择式自动布线](#5)外，您还可以选择一次性自动布线整个设计。
...
您也可以按 F4 开始自动布线。每个自动布线传递完成后，结果会出现在命令窗口的[状态选项卡](/router/guide/5_zh.md#2-1)中。

如果命令窗口未打开，请打开它：

在标准工具栏上，点击 **命令窗口** 按钮。

自动布线完成后，命令窗口的[状态选项卡](/router/guide/5_zh.md#2-1)中会出现一个指向布线报告的链接。

> [!tip] 除了本教程课程中定义的规则外，SailWind Router 还支持具有高速规则的自动布线，包括最小、最大和匹配长度、差分对以及使用蛇形导线或曲折的导线调整。

**使用暂停和恢复**

您可以在自动布线过程中的任何时候暂停、恢复或[停止自动布线](/router/guide/17_zh.md#10)过程。这使您可以查看进度，并[停止自动布线](/router/guide/17_zh.md#10)以更改策略或继续当前的自动布线操作。

**暂停和[恢复自动布线](/router/guide/17_zh.md#9)**

暂停会暂停当前的自动布线操作。当您恢复时，自动布线操作将从您暂停的地方继续。

1. 在自动布线过程中，点击布线工具栏上的 **[暂停自动布线](/router/guide/17_zh.md#8)** 按钮。

> [!tip] 您可以在工具菜单 > 选项 > 策略选项卡中为每种传递类型设置暂停功能。

2. 尝试使用缩放来查看自动布线的当前结果。

3. 在布线工具栏上，点击 **[恢复自动布线](/router/guide/17_zh.md#9)** 按钮以[恢复自动布线](/router/guide/17_zh.md#9)。

4. 完成后，不要保存设计的副本。

**您已完成[自动布线设计](/router/guide/17_zh.md#7)准备教程。**