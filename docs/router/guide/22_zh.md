...
点击**自动布线 > [预布线分析](/router/guide/17_zh.md#14-1)**菜单项。
...
测试点报告的格式如下所述。更多信息，请参考"[创建测试点报告](#8)"。
...
布线报告的格式如下。更多信息，请参考"[创建布线报告](#10)"在。
