...
2. 点击要选择的路径起点。鼠标变为路径选择符号，标记路径的起点
...
2. 在选择层列表(Selection Layers list)（[选择层对话框](/router/guide/24_zh.md#81)(Selection Layers dialog box)中），选中您希望在设计中能够选择的每个层的复选框；如果要禁用某个层的选择，清除其复选框
